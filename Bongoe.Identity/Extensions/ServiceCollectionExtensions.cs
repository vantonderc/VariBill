...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddCors(options =>
        {
            ...
            {
                policy.WithOrigins(
                        "https://localhost:7253",  // MVC App
                        "https://localhost:7055",  // Blazor
                        "https://localhost:5005",  // Other
                        "https://localhost:5006"   // Other
                    )
                    .AllowAnyMethod()
                    .AllowAnyHeader()
                    .AllowCredentials();
        ...
        services.AddCors(options =>
        {
            options.AddPolicy("BongoePolicy", policy =>
            {
                policy.WithOrigins("https://localhost:7253") // Your MVC app's URL
                      .AllowAnyMethod()
                      .AllowAnyHeader()
                      .AllowCredentials();
            });
